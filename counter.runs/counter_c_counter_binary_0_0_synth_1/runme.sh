...
HD_PWD='C:/FPGA_EGR680/counter/counter.runs/counter_c_counter_binary_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_c_counter_binary_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_c_counter_binary_0_0.tcl
